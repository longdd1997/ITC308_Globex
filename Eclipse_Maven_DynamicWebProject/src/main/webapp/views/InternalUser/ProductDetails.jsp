...
<table>
  <tr>
    ...
    <td><input type="text" name="txtProductID" value="01" disabled></td> 
  </tr>
  <tr>
    <td><b><h3>Product Name:</h3></b></td>
    <td><input type="text" name="txtProductName" value="Compact Utility Tractor" disabled></td> 
  </tr>
  <tr>
  ...
  <tr>
    <td><h3>Stock:</h3></td>
    <td><input type="text" name="txtProductStock" value="549" disabled></td> 
  </tr>
  <tr>
    <td><h3>Stock Date:</h3></td>
    <td><input type="text" name="txtProductStockDate" value="03/03/2018" disabled></td> 
  </tr>
  <tr>
    <td><h3>Price:</h3></td>
    <td><input type="text" name="txtProductPrice" value="$25,000" disabled></td> 
  </tr>
   <tr>
    <td><h3>Description:</h3></td>
    <td>
    	<textarea rows="10" cols="50" name="txtProductDescription" disabled>
