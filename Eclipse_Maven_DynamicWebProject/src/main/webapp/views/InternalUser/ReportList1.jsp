...
<hr/>
<h1>Report list of most sold product in a specified period time</h1>
<hr/>
Enter a period of time
<input type="text" name="txtStart" value="03/03/2018"> to 
<input type="text" name="txtEnd" value="15/03/2018">
